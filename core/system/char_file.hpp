/*
 * Created by switchblade on 13/09/22
 */
...
namespace sek
{
	...
	extern template class SEK_API_IMPORT sek::basic_char_file<char>;
	extern template class SEK_API_IMPORT sek::basic_char_file<wchar_t>;
